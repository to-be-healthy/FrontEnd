          ...
          <div className={cn(Typography.HEADING_4, 'flex w-full flex-col gap-y-3')}>
            <Button
              className={cn(
                ...
                'h-20 bg-gray-100 p-0 px-[42px] py-4 text-black'
              )}
              asChild>
    ...
    <Layout className='bg-white'>
      ...
      <Layout.Contents>
        <div className={'mt-[48px] flex flex-col items-center gap-y-9'}>
          ...
          <RollingBanner>
            <div className='mx-[5px] flex w-[120px] flex-col items-center gap-y-[14px] rounded-lg bg-[#FFDC7A] px-4 py-[17px]'>
              <Image
            ...
            <div className='mx-[5px] flex w-[120px] flex-col  items-center gap-y-[14px] rounded-lg bg-[#82C3FF] px-4 py-[17px]'>
              <Image
